  ...
  <li><a href="contact.html">Contact Us</a></li>
	...
	<div id="site_content">	
		...
		<div id="main_wrapper">
		 ...
		 <%
                ArrayList<String> MotherboardNames = new ArrayList<String>(); 
				 ArrayList<String> MotherboardPrice = new ArrayList<String>();
				  ArrayList<String> MotherboardPhoto = new ArrayList<String>();
				  ArrayList<String> MotherboardDescription = new ArrayList<String>();
				  ArrayList<String> MotherboardLink = new ArrayList<String>();
				  
			
            try {
                Connection con = (Connection) DriverManager.getConnection("jdbc:neo4j://localhost:7474/");
                String query = ("Match (n:`Motherboard`) return n");
            ...
            try(ResultSet rs = stmt.executeQuery()){
				while (rs.next()) {
					...
					MotherboardNames.add(name);
					MotherboardPrice.add(price);
					MotherboardPhoto.add(photo);
					MotherboardLink.add(link);
					MotherboardDescription.add(description);
		...
		<%	for(int i = 0; i < 500; i++)
			...
			<div id = <%= i %> class = "product_wrapper"> 	
			  <br><img src=<%=MotherboardPhoto.get(i)%> width="50%" height="50%"/></br>
			  <br><%=MotherboardNames.get(i)%></br>
			  <br>€ <%=MotherboardPrice.get(i)%></br>
					<div id = "hover_info">
				<p><a href=<%=MotherboardLink.get(i)%> class='linkToWebsite'>Go to website</a></p>	
					<b>Description:</b>		
				<p><%=MotherboardDescription.get(i)%></p>
